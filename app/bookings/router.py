...
from app.bookings.schemas import BookingFilterStatusDeletedBookedPractPatientSchema, PatientBookingDataForPractitionerSchema, TakeBookingByPatientFormSchema
from app.bookings.services import admin_booking_list_service, user_booking_list_service, user_delete_booking_service, user_take_booking_service
...
async def user_get_all_own_booking(
    current_user: Annotated[User, Depends(get_current_user)],
    db: Annotated[AsyncSession, Depends(get_db)],
)->List[PatientBookingDataForPractitionerSchema]:
