...
from app.availabilities.exceptions import avail_already_soff_deleted_error_msg, pract_try_soft_delete_inexistant_avail_slot_error_msg, pract_try_soft_delete_not_own_avail_error_msg, user_try_to_create_avail_when_not_the_practitioner_error_msg
